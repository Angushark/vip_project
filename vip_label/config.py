...
VID_STRIDE = 80                    # Video frame stride (extract 1 frame every N frames)
CONFIDENCE_THRESHOLD = 0.25        # Confidence threshold (0-1)
...
ROBOFLOW_PROJECT = "drowning-detection-h5gv0-bs2gm"
